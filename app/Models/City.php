...
class City extends Model
{
    ...
    public function getCityListData($request){
    	...
    	return Datatables::of($sql)
    						->addColumn('action',function($data){
    							return '<a href="'.route('admin.cities.edit',Crypt::encrypt($data->id)).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>   
									<a href="javascript:void(0)" data-route="'.route('admin.cities.destroy',Crypt::encrypt($data->id)).'" class="btn btn-xs btn-danger delete_record"><i class="fa fa-trash" aria-hidden="true"></i></a>';
    						})
							...
							->rawColumns(['id','action','status','state_name'])
    						->make(true);
    }

    public function saveCity($r,$id=NULL){
        ...
        $msg = "City save Successfully Done.";
    ...
    public function deleteAll($r){
        ...
        foreach ($input['checkbox'] as $key => $c) {
            ...
            $obj->delete();
            $msg = "City Record Deleted Successfully.";
        }
        return response()->json(['success' => 1, 'msg' => "City deleted successfully"]);   
    }
