            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="" class="col-sm-2 control-label">Blog Category <span class="has-error">*</span></label>
                  <div class="col-sm-5">
                    {{ Form::select('blog_category_id',[''=>'Select blog category']+ \App\Models\BlogCategory::getCategoryDropDown(),null,['id'=>'',"class"=>"form-control"])
                    }}
                  </div>
                </div>
